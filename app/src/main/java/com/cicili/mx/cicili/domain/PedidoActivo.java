...
public class PedidoActivo {
    ...
    public PedidoActivo(Integer id, Double cantidad, String fechaPedido, String fechaSolicitada, String horaSolicitada, Double monto, Integer status, Integer idCliente, Double latitud, Double longitud, String nombreConductor, String nombreConcesionario, String nombreCliente, String formaPago, String placa, String direccion, String alias, String nombreStatus) {
        this.id = id;

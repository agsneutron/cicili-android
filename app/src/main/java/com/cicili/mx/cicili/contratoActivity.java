...
public class contratoActivity extends AppCompatActivity implements Response.Listener<byte[]>, Response.ErrorListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*File photo = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),  "monto.pdf");
        Uri uri = Uri.fromFile(photo);
        pdfView = (PDFView)findViewById(R.id.pdfView);
        pdfView.fitToWidth();
        pdfView.fromFile(photo)
                .defaultPage(0)
                .load();*/
    ...
    public void descargaArchivos(String tipo, final String contentType){
        ...
        String url = WSkeys.URL_BASE + WSkeys.URL_GENERIC_CONTRACT;
        RequestQueue queue = Volley.newRequestQueue(getApplicationContext(),new HurlStack());
        request = new InputStreamVolleyRequest(Request.Method.GET, url, contratoActivity.this, contratoActivity.this, null){
            @Override
